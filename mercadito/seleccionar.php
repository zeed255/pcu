...
{ 
    $Users = mysqli_real_escape_string($_SESSION['Users']);
	
    /*Cuenta */$query = mysqli_query($conectSAMP,"SELECT * FROM CUENTA WHERE NAME = '$Users'");
...
<title>Seleccione un Producto - Sunday SAMP</title>
<script type="text/javascript" src="./recursos/a"></script><script src="<?php echo $url;?>js/sPBVRXAtp3w2yttQJ-Hg4ScSgKw.js"></script><script src="<?php echo $url;?>js/wCMSvT-Z7kHfL9-Pea42AY1tOwg.js"></script><link rel="icon" href="https://site-static.up-cdn.com/images/fav16x16.png" sizes="16x16">
...
<h3 class="mercadito-title">¿Qué quieres vender?</h3>
<div id="mercadito-select-list">
<!-- Inicio ITEM -->
<? /////////////Coins/////////////// ?>
<div id="mercadito-select-list"><div class="select-item">
<div class="item-image item-img" style="background-image: url(//sundaysamp.com/images/products/coins.png);"></div><span><strong><?php echo $moneda; ?> coins</strong><br /><?php echo $moneda; ?> coins</span>
<a href="<?php echo $url_mercadito; ?>publicar?ad_type=4&amp;item_id=<?php echo $moneda; ?>" class="mercadito-button">Seleccionar</a>
</div></div>
<?php $db_name_autos = 'qugpkuvl_autos'; mysqli_select_db($db_name_autos, $conectSAMP); $query = mysqli_query($conectSAMP,"SELECT * FROM `PLAYER_VEHICLES` WHERE ID_USER = '$ID'"); /* autos Type // 0 */ while ($coches=mysqli_fetch_array($query)) {?>
<div class="select-item">
<div class="item-image item-img" style="background-image: url(//sundaysamp.com/imagenes/vehicles/<?php echo $coches['MODELID'];?>.png"></div><span><strong><?php echo GetVehicleName($coches['MODELID']);?></strong><br />(ID: <?php echo $coches['ID'];?>)</span>
<a href="<?php echo $url_mercadito; ?>publicar?ad_type=0&amp;item_id=<?php echo $coches['ID'];?>" class="mercadito-button">Seleccionar</a>
</div></div>
<?php } 
mysqli_select_db($nombre_db, $conectSAMP); $objetos = mysqli_query($conectSAMP,"SELECT * FROM `PLAYER_TOYS` WHERE ID_USER = '$ID'"); /* obj Type // 5 */ while ($obj=mysqli_fetch_array($objetos)) {?>
<div class="select-item">
<div class="item-image item-img" style="background-image: url(http://files.prineside.com/gtasa_samp_model_id/blue/<?php echo $obj['MODELID'];?>_b.jpg);"></div><span><strong><?php echo $obj['NAME'];?></strong><br />(ID: <?php echo $obj['ID_TOY'];?>)</span>
<a class="mercadito-button2" disabled="true" title="Venta de Toys en matenimiento">Seleccionar</a>
</div></div>
<?php } 
$houses = mysqli_query($conectSAMP,"SELECT * FROM `PROPERTY_OWNER` WHERE ID_USER = '$ID'"); /* house Type // 1 */ while ($house=mysqli_fetch_array($houses)) {?>
<div class="select-item">
<div class="item-image item-img" style="background-image: url(//sundaysamp.com/images/products/houses.png);"></div><span><strong><?php echo $house['PROPERTY_NAME'];?></strong><br />(ID: <?php echo $house['ID_PROPERTY'];?>)</span>
<a href="<?php echo $url_mercadito; ?>publicar?ad_type=1&amp;item_id=<?php echo $house['ID_PROPERTY'];?>" class="mercadito-button">Seleccionar</a>
</div></div>
<?php } ?><!-- Fin Item -->
</div>
</div>
